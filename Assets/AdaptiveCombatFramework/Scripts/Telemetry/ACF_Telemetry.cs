...
namespace AdaptiveCombatFramework {
    public class Telemetry : MonoBehaviour
    {
        ...
        [Tooltip("Frequency in seconds at which summary reports are printed to the console.")]
        [SerializeField] private float logInterval = 5f;
        [Tooltip("The time window (in seconds) used to calculate 'Recent' metrics like DPS or Stamina Usage.")]
        [SerializeField] private float _historyWindow = 10f; 

        [Header("Object References")]
        [Tooltip("Reference to the Player's transform for spatial calculations.")]
        [SerializeField] private Transform playerTransform;
        [Tooltip("Reference to the Enemy's transform.")]
